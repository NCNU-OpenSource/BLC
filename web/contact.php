...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      <div class="container">
        <a class="navbar-brand" href="index.html">BLC</a>
    ...
    <section class="ftco-section contact-section ftco-degree-bg">
      <div class="container bg-light">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="w-100"></div>
          <div class="col-md-3">
            <p><span>Address:</span> Chi-Nan University</p>
          </div>
          <div class="col-md-3">
            <p><span>Phone:</span> <a href="tel://0916065549">+886 916065549</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Email:</span> <a href="mailto:tingting2733682@gmail.com">tingting2733682@gmail.com</a></p>
          </div>
        </div>
