        ...
        <div class="section-2-blocks-wrapper row d-flex">
          ...
          <div class="text col-lg-6 order-first ftco-animate">
            <div class="text-inner align-self-start">
              <h3 class="heading">Welcome to BLC</h3>
              <p>We are devoted to making a better place to you guys who want to have a fabulous relationship. Hope you can enjoy our service and meet your Prince Charming.</p>
              <p>In our club, we provide buffet, coffee and books for free. You can have wonderful experiences here. What's more, when the people whom you followed entry here, we'll send you a telegram messenge. </p>
              <p>To prevent you from perverts, you can block them in the websites, and we won't send your messages to them. </p>
            </div>
          </div>
        </div>
      </div>
